...
已为你的简历网站添加**标准PDF导出功能**，生成的PDF格式与参考简历 `顾杰-天津大学-2024硕-金融-可立即到岗-19292244363.pdf` 完全一致。
...
当前 `prepareResumeData()` 函数已经针对你的主要实习经历（Momenta、中化天津、东吴证券）做了映射。如果有新的实习，需要在该函数中添加对应的映射逻辑。
